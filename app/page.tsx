...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary">
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Comprehensive case management solution designed specifically for law
            firms. Manage cases, track hearings, and collaborate efficiently.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <Card className="p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-muted-foreground">
              Efficiently manage and track all your cases in one place. Assign
              cases, update statuses, and monitor progress.
            </p>
          </Card>
          ...
          <Card className="p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-muted-foreground">
              Keep all case-related documents organized and easily accessible.
          ...
          <Card className="p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-muted-foreground">
              Stay on top of all court dates and deadlines. Get reminders and
      ...
      <footer className="bg-muted mt-32 py-6">
